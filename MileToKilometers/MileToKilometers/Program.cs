...
namespace MileToKilometers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The number of miles entered was {0}, and that equals {1} kilometers.", milesEntry, kilo);
        ...
        public static void displayEnterActiveConversion()
        {
            ...
            Console.Write("Just enter some miles >>>> ");
            milesEntryString = Console.ReadLine();
            milesEntry = Convert.ToDouble(milesEntryString);

            kilo = KILO_TO_MILES * milesEntry;
            Console.WriteLine("The nimber of miles entered was {0}, and that equals {1} kilometers.", milesEntry, kilo);
        }
    }
}